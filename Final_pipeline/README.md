...
| 테스트 | `tests/test_extract_swatches.py` | — | `pytest tests` |
...
G01–G05 = 21, 26, 32, 21, 22개(합계 122), 격자 시작 위치 (34,147), (227,231), (346,208), (40,331), (118,66) px가 나옵니다.
...
4. 유효 셀 수가 최대인 시작 위치를 선택(동률이면 y가 작은 것, 그다음 x가 작은 것).
5. 선택된 격자의 유효 셀을 행 우선 순서로 저장하고, 포함·비중첩·면적을 픽셀 단위로 재검증.
